...
import {__platform_browser_dynamic_private__ as dr} from '@angular/platform-browser-dynamic';
...
export var INTERNAL_BROWSER_DYNAMIC_PLATFORM_PROVIDERS:
    typeof dr.INTERNAL_BROWSER_DYNAMIC_PLATFORM_PROVIDERS =
    dr.INTERNAL_BROWSER_DYNAMIC_PLATFORM_PROVIDERS;
