...
exports.FakeXsrfStrategy = FakeXsrfStrategy;
function makeServerModule(args) {
    ...
    var providers = [
        { provide: http_1.XSRFStrategy, useClass: FakeXsrfStrategy },
        { provide: http_1.CookieXSRFStrategy, useClass: FakeXsrfStrategy },
    ];
