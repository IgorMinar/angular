...
import { Component, ContentChildren, ElementRef, EventEmitter, Input, Optional, Output, Renderer2, Self, ViewEncapsulation, ViewChild, ChangeDetectorRef, Attribute, Inject, ChangeDetectionStrategy, InjectionToken, } from '@angular/core';
import { NgForm, FormGroupDirective } from '@angular/forms';
import { MdOption, MdOptgroup } from '../core/option/index';
 ...
 */
export var SELECT_OPTION_HEIGHT_ADJUSTMENT = (SELECT_ITEM_HEIGHT - SELECT_TRIGGER_HEIGHT) / 2;
/**
 ...
 */
export var MD_SELECT_SCROLL_STRATEGY = new InjectionToken('md-select-scroll-strategy');
/**
 * \@docs-private
 * @param {?} overlay
 * @return {?}
 */
export function MD_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay) {
    return function () { return overlay.scrollStrategies.reposition(); };
}
/**
 * \@docs-private
 */
export var MD_SELECT_SCROLL_STRATEGY_PROVIDER = {
...
export var /** @type {?} */ _MdSelectMixinBase = mixinColor(mixinDisabled(MdSelectBase), 'primary');
