...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, Directive, ElementRef, Renderer2, EventEmitter, Input, Optional, Output, ViewEncapsulation, forwardRef, ViewChild, } from '@angular/core';
...
export { MdRadioGroupBase };
export var /** @type {?} */ _MdRadioGroupMixinBase = mixinDisabled(MdRadioGroupBase);
/**
...
var MdRadioGroup = (function (_super) {
    ...
    MdRadioGroup.prototype._emitChangeEvent = function () {
        if (this._isInitialized) {
            var /** @type {?} */ event_1 = new MdRadioChange();
...
export var /** @type {?} */ _MdRadioButtonMixinBase = mixinColor(mixinDisableRipple(MdRadioButtonBase), 'accent');
/**
